...
<head>
    <meta charset="utf-8">
    <title>Webdevkin. Интернет-магазин. Заказ</title>
    <meta name="description" content="Тестовый интернет-магазин от webdevkin-a. Оформление заказа и отправка его на сервер" />
...
<body data-page="order">
    <div class="container">
        <h1>Оформление заказа. Интернет-магазин Auto Shop</h1>
        <br />
        <br />
        <ul class="nav nav-pills">
            <li><a href="/">Каталог</a></li>
            <li><a href="catalog.jsp">Каталог с фильтрами</a></li>
            <li><a href="catalog-pag.jsp">Каталог с пагинацией</a></li>
            <li id="compare-tab"><a href="compare.jsp">Сравнение товаров<span class="badge"></span></a></li>
            <li><a href="cart.jsp">Корзина<span id="total-cart-count" class="badge"></span></a></li>
            <li class="active"><a href="order.jsp">Оформление заказа</a></li>
        </ul>
        <br />
        <br />
        ...
        <form id="order-form" class="form-horizontal" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="radio">
                        <label><input type="radio" name="delivery" class="js-delivery-type" data-type="В пределах КАД" data-summa="200">В пределах КАД (200 грн)</label>
                    </div>
                    <div class="radio">
                        <label><input type="radio" name="delivery" class="js-delivery-type" data-type="Почта России" data-summa="40">Доставка Новой почтой(от 40 грн)</label>
                    </div>
                    <br />
    ...
    <script id="order-message-template" type="text/template">
        <@ if (count !== 0) { @>
            В Вашей корзине <@= count @> товара(ов) на общую сумму <@= summa @> грн.
    ...
    <script src="../../resources/js/modules/order.js" type="text/javascript"></script>
