...
<%--    <link href="resources/components/jquery-ui/jquery-ui.min.css" rel="stylesheet" type="text/css">--%>
...
<body data-page="catalogDB">
    <div class="container">
        <ul class="nav nav-pills">
            ...
            <li><a href="order.jsp">Оформление заказа</a></li>
        </ul>
        <br />
    ...
    <script src="../../resources/components/jquery-ui/jquery-ui.min.js" type="text/javascript"></script>
    <script src="../../resources/js/vendor/underscore.min.js" type="text/javascript"></script>
    <script src="../../resources/js/modules/catalogDB.js" type="text/javascript"></script>
